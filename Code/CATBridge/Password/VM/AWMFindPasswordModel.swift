...
public struct AWMFindPasswordModel: WLBaseViewModel {
    ...
    init(_ input: WLInput ,disposed: DisposeBag) {
            ...
            .flatMapLatest({ (username) in
                ...
                case .ok:
                    ...
                    let result: Observable<WLBaseResult> = Observable<WLBaseResult>.create({ (ob) -> Disposable in
                        ...
                        awmVoidResp(AWMApi.smsPassword(username))
        ...
        let completed: Driver<WLBaseResult> = input
            ...
            .flatMapLatest {
                ...
                switch awmCheckPasswordForget($0.0, vcode: $0.1, password: $0.2) {
                case .ok:
                    
                    return awmVoidResp(AWMApi.resettingPassword($0.0, password: $0.2, code: $0.1))
