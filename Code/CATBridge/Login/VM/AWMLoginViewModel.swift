...
public struct AWMLoginViewModel: WLBaseViewModel {
    ...
    init(_ input: WLInput) {
        ...
        let logined: Driver<WLBaseResult> = input
            ...
            .flatMapLatest {
                ...
                switch awmCheckUsernameAndPassword($0.0, password: $0.1) {
                case .ok:

                    return awmDictResp(AWMApi.login($0.0,password: $0.1))
