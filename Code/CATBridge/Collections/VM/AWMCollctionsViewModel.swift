...
struct AWMCollectionsViewModel: WLBaseViewModel {
    ...
    struct WLOutput {
        ...
        let collectionData: BehaviorRelay<[AWMCircleBean]> = BehaviorRelay<[AWMCircleBean]>(value: [])
        ...
        headerRefreshData
            .drive(onNext: { (result) in
                ...
                case let .fetchList(items):
                    ...
                    output.collectionData.accept(items as! [AWMCircleBean])
