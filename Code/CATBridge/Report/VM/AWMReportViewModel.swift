...
@objc public final class AWMReportBean: NSObject,IdentifiableType ,Mappable {
    public init?(map: Map) {
...
struct AWMReportViewModel: WLBaseViewModel {
    ...
    struct WLInput {
        ...
        let modelSelect: ControlEvent<AWMReportBean>
    ...
    struct WLOutput {
        ...
        let zip: Observable<(AWMReportBean,IndexPath)>
        
        let tableData: BehaviorRelay<[AWMReportBean]> = BehaviorRelay<[AWMReportBean]>(value: [])
    ...
    init(_ input: WLInput ,disposed: DisposeBag) {
        ...
        let completed: Driver<WLBaseResult> = input
            ...
            .flatMapLatest {
                ...
                return awmVoidResp(AWMApi.report(input.uid, targetEncoded: input.encode, type: $0.0, content: $0.1))
        ...
        for item in input.reports {
            ...
            let res = AWMReportBean(JSON: item)
