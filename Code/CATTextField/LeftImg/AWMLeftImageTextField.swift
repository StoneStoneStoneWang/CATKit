...
import UIKit
@objc (AWMLeftImageTextField)
open class AWMLeftImageTextField: AWMBaseTextField {
...
extension AWMLeftImageTextField {
    
    
    @objc open override func makeAttribute(_ closure: @escaping (AWMLeftImageTextField) -> ()) {
