...
#import "AWMCarouselViewController.h"

@import AWMBridge;
@import SToolsKit;
@import Masonry;

@interface AWMCarouselCollectionViewCell : UICollectionViewCell
...
@implementation AWMCarouselCollectionViewCell
...
@interface AWMCarouselFormOneLayout : UICollectionViewFlowLayout



@end

@implementation AWMCarouselFormOneLayout
...
@interface AWMCarouselFormTwoLayout : UICollectionViewFlowLayout

#define AWMCarouselHeight KSSCREEN_WIDTH / 3
@end
@implementation AWMCarouselFormTwoLayout
...
@interface AWMCarouselViewController ()
...
@implementation AWMCarouselViewController
...
- (void)addOwnSubViews {
    ...
    AWMCarouselFormOneLayout *layout = [AWMCarouselFormOneLayout new];
    
#elif AWMCarouselTwo
    
    AWMCarouselFormTwoLayout *layout = [AWMCarouselFormTwoLayout new];
#elif AWMCarouselThree
    AWMCarouselFormOneLayout *layout = [AWMCarouselFormOneLayout new];
#endif
...
- (void)configOwnSubViews {
    ...
    [self.collectionView registerClass:[AWMCarouselCollectionViewCell class] forCellWithReuseIdentifier:@"image"];
...
- (void)configViewModel {
    ...
    [bridge createCarousel:self canPageHidden:false canTimerResp:false carousels:AWMCarouselImgs style:AWMCarouselStyleNormal carouseAction:^(AWMCarouselBean * _Nonnull carouse) {
...
- (UICollectionViewCell *)configCollectionViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    AWMCarouselCollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:@"image" forIndexPath:ip ];
