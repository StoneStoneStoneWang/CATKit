...
#import "CATCarouselViewController.h"

@import CATBridge;
@import SToolsKit;
@import Masonry;

@interface CATCarouselCollectionViewCell : UICollectionViewCell
...
@implementation CATCarouselCollectionViewCell
...
@implementation CATCarouselFormOneLayout
...
@interface CATCarouselViewController ()
...
@implementation CATCarouselViewController
...
- (void)addOwnSubViews {
    ...
    CATCarouselFormOneLayout *layout = [CATCarouselFormOneLayout new];
    
#elif CATCarouselTwo
    
    CATCarouselFormTwoLayout *layout = [CATCarouselFormTwoLayout new];
#elif CATCarouselThree
    CATCarouselFormOneLayout *layout = [CATCarouselFormOneLayout new];
#endif
...
- (void)configOwnSubViews {
    ...
    [self.collectionView registerClass:[CATCarouselCollectionViewCell class] forCellWithReuseIdentifier:@"image"];
...
- (void)configViewModel {
    ...
    [bridge createCarousel:self canPageHidden:false canTimerResp:false carousels:CATCarouselImgs style:CATCarouselStyleNormal carouseAction:^(CATCarouselBean * _Nonnull carouse) {
...
- (UICollectionViewCell *)configCollectionViewCell:(id)data forIndexPath:(NSIndexPath *)ip {
    ...
    CATCarouselCollectionViewCell *cell = [self.collectionView dequeueReusableCellWithReuseIdentifier:@"image" forIndexPath:ip ];
